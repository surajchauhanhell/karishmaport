...
await page.getByRole('button',{name:'Read / update'}).click();
await page.getByText('Please share more information about this product.',{exact:true}).waitFor();
await page.getByLabel('Status',{exact:true}).selectOption('read');await page.getByRole('button',{name:'Save changes'}).click();
...
console.log('Mocked form-to-inbox contracts passed for contact and collaboration, including reading and status update.');

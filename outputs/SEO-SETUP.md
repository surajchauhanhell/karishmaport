...
Canonical domain: https://karishmaport.vercel.app
...
1. Add `https://karishmaport.vercel.app/` as a URL-prefix property in Google Search Console.
...
3. Submit `https://karishmaport.vercel.app/sitemap.xml` and inspect the homepage and portfolio URL.
